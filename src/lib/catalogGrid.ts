...
export const CATALOG_GRID_HORIZONTAL =
  'grid h-full w-full grid-cols-2 gap-2 sm:grid-cols-3 sm:gap-3 md:grid-cols-4 lg:grid-cols-4';
...
export const CATALOG_GRID_HORIZONTAL_SEARCH =
  'grid w-full grid-cols-2 gap-2 sm:grid-cols-3 sm:gap-3 md:grid-cols-4 lg:grid-cols-4';
