...
// Tailwind only emits arbitrary values it can read literally in the source, so the
// nav offset here has to stay spelled out. Keep it in sync with NAV_BLEED_EXTEND_REM.
