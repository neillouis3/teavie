...
export default function SmallCardLoading() {
  return (
    <div className="flex w-full min-w-0 flex-col gap-1.5 rounded-xl">
      <div className="aspect-[2/3] w-full shrink-0 animate-pulse rounded-2xl bg-default-200" />
      <div className="w-full shrink-0 space-y-2">
        ...
        <div className="h-9 w-full max-w-[92%] animate-pulse rounded bg-default-200" />
      </div>
    </div>
  );
}
